...
string importFolder = Path.Combine(Path.GetDirectoryName(ScriptPath), @"Fonts\");
...
{
    using(StreamReader reader = new StreamReader(sourcePath + "glyphs_" + newFont.Name.Content + ".txt"))
    {
        ...
        while ((line = reader.ReadLine()) != null)
        {
            ...
            if (head == 0)
            {
                ...
                newFont.Ascender = UInt32.Parse(s[8]);
                newFont.AscenderOffset = Int32.Parse(s[9]);
                head++;
            }
